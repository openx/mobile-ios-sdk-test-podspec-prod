Pod::Spec.new do |s|
  ...
  s.source         = { :http => 'https://sdk.prod.gcp.openx.org/apollo/ios/event-handlers/MoPub/1.1.0/OpenX_Apollo_MoPub_Adapters_iOS_1.1.0.zip' }
  s.ios.vendored_frameworks = 'OpenX_Apollo_MoPub_Adapters_iOS_1.1.0/OpenXApolloMoPubAdapters.framework'
