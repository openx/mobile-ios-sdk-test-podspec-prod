Pod::Spec.new do |s|
  ...
  s.source         = { :http => 'https://sdk.prod.gcp.openx.org/apollo/ios/event-handlers/MoPub/1.2.0/OpenX_Apollo_MoPub_Adapters_iOS_1.2.0.zip' }
  s.ios.vendored_frameworks = 'OpenX_Apollo_MoPub_Adapters_iOS_1.2.0/OpenXApolloMoPubAdapters.framework'
  
  ### For local lint:
  # s.subspec 'openx-apollo-sdk' do |ss| ss.source_files = 'OpenX_Apollo_SDK_iOS_1.2.0/OpenXApolloSDK.framework/**/*.{h,m}' end
  # s.default_subspecs = 'main'
  
  # s.subspec 'main' do |ms| 
  s.dependency    'openx-apollo-sdk', '1.2.0'
  s.dependency    'mopub-ios-sdk', '5.15'
