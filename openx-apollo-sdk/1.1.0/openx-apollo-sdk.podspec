Pod::Spec.new do |s|
  ...
  s.source         = { :http => 'https://sdk.prod.gcp.openx.org/apollo/ios/sdk/1.1.0/OpenX_Apollo_SDK_iOS_1.1.0.zip' }
  s.ios.vendored_frameworks = 'OpenX_Apollo_SDK_iOS_1.1.0/OpenXApolloSDK.framework'
