Pod::Spec.new do |s|
  ...
  s.source            = { :http => 'https://sdk.prod.gcp.openx.org/ios/4.12.0/OpenX_Mobile_SDK_iOS_4.12.0.zip' }

  s.requires_arc  = true
  s.ios.deployment_target = '8.0'
  s.ios.vendored_frameworks = 'OpenX_Mobile_SDK_iOS_4.12.0/OpenXSDKCore.framework'
