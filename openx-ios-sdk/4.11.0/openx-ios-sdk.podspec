Pod::Spec.new do |s|
  ...
  s.source           = { :http => 'https://storage.googleapis.com/ox-cdn-prod-mobile/sdks/release/ios/4.11.0/OpenX_Mobile_SDK_iOS_4.11.0.zip' }

  s.requires_arc  = true
  s.ios.deployment_target = '8.0'
  s.ios.vendored_frameworks = 'OpenX_Mobile_SDK_iOS_4.11.0/OpenXSDKCore.framework'
